...
public record ArtistDiscographyAlbumObject
{
    ...
    public required IReadOnlyList<SimplifiedArtistObject> Artists { get; init; }

    [JsonPropertyName("album_group")]
    public required AlbumGroup AlbumGroup { get; init; }
}
